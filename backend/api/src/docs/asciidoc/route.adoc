...
- Body
include::{snippets}/route-like-create-update/http-request.adoc[]
include::{snippets}/route-like-create-update/path-parameters.adoc[]

성공 응답 HTTP
include::{snippets}/route-like-create-update/http-response.adoc[]
...
include::{snippets}/route-review-like-create-update/http-request.adoc[]
include::{snippets}/route-review-like-create-update/path-parameters.adoc[]

성공 응답 HTTP
include::{snippets}/route-review-like-create-update/http-response.adoc[]
